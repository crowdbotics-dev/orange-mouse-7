"""
Django settings for orange_mouse_7 project.
...
ROOT_URLCONF = 'orange_mouse_7.urls'
...
WSGI_APPLICATION = 'orange_mouse_7.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Orange Mouse Support <support@orange-mouse-7.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_mouse_7 API",
    "DESCRIPTION": "API documentation for orange_mouse_7 App",
    "VERSION": "v1",
}
